...
try:
    ...
    pytest.skip("algorithms.tracking.gimbal 尚未实现，跳过测试", allow_module_level=True)
...
class TestComputeGimbalAngles:
    ...
    def test_due_north(self):
        ...
        pan, tilt = compute_gimbal_angles(
            ...
            target_lat=27.005, target_lon=125.0, target_alt=0.0,
        )
    ...
    def test_due_east(self):
        ...
        pan, tilt = compute_gimbal_angles(
            uav_lat=27.0, uav_lon=125.0, uav_alt=300.0,
            target_lat=27.0, target_lon=125.005, target_alt=0.0,
        )
    ...
    def test_due_south(self):
        """目标在正南 → pan ≈ ±180°。"""
        pan, tilt = compute_gimbal_angles(
            uav_lat=27.005, uav_lon=125.0, uav_alt=300.0,
            target_lat=27.0, target_lon=125.0, target_alt=0.0,
        )
    ...
    def test_far_target_low_tilt(self):
        ...
        pan, tilt = compute_gimbal_angles(
            uav_lat=27.0, uav_lon=125.0, uav_alt=300.0,
            target_lat=27.1, target_lon=125.1, target_alt=0.0,
        )
    ...
    def test_pan_range(self):
        ...
        for dlat, dlon in [(0.001, 0), (0, 0.001), (-0.001, 0), (0, -0.001)]:
            pan, tilt = compute_gimbal_angles(
                uav_lat=27.0, uav_lon=125.0, uav_alt=300.0,
                target_lat=27.0 + dlat, target_lon=125.0 + dlon, target_alt=0.0,
            )
