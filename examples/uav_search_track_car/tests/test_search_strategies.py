...
from search_track.search_strategies import (
    SpiralParams,
    spiral_next_waypoint,
    sweep_orientation,
)
...
def test_spiral_clamps_to_search_radius():
    p = SpiralParams(
        ...
        base_alt=300.0,
        search_radius=300.0,
        spiral_growth_rate=50.0,
        angular_speed_dps=360.0,
    )
    lat, _lon, _ = spiral_next_waypoint(3600.0, p)  # many revolutions
